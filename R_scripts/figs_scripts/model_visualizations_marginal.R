...
pdf(here("figs", "par_est_marg.pdf"), width = 15, height = 8)
...
pdf(here("figs", "Par_est_AIC_marg.pdf"), width = 17, height = 10)
...
# Now, plot!
png(here("figs", "ebs_pollock_WAA_models_tile_marg.png"), width = 1600, height = 1300)
