# Purpose: To visualize GMRF models for walleye Pollock (for marginal variance)
...
pdf(here("figs", "par_est_cond.pdf"), width = 15, height = 8)
...
pdf(here("figs", "Par_est_AIC_cond.pdf"), width = 17, height = 10)
...
# Now, plot!
png(here("figs", "ebs_pollock_WAA_models_tile_cond.png"), width = 1600, height = 1300)
...
png(here("figs", "proj_waa_sd_cond.png"), width = 1400, height = 800)
