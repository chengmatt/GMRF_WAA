...
|test|R scripts testing the development of the TMB model and checks for correct model dimensions, also contains scripts for 3dgrmf and 2dar1 WAA models written in RTMB|
